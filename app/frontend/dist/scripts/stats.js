...
async function get_user_stats() {
    ...
    function updateAiStats(ai) {
        const aiWinsText = document.getElementById(`${ai.difficulty}-ai-wins`);
        const aiWins = ai.wins;
        const aiLossesText = document.getElementById(`${ai.difficulty}-ai-losses`);
        const aiLosses = ai.losses;
        const aiGamesText = document.getElementById(`${ai.difficulty}-ai-games`);
        const aiGames = aiWins + aiLosses;
        const aiRatioBar = document.getElementById(`${ai.difficulty}-ai-ratio`);
